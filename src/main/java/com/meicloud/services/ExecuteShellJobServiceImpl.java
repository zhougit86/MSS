...
public class ExecuteShellJobServiceImpl implements ExecuteJobService {

   private static Logger LOG = LoggerFactory.getLogger(ExecuteShellJobServiceImpl.class);
   @Autowired
   ...
   public ExecuteShellJobServiceImpl() {
   ...
   public void executeJob(RunJob runJob) throws Exception {
      ...
      if(running >= paralle) {
         ...
         logFilePath = logFilePath + "shell/logs/";
         ...
         try {
            ...
            String cmd = FileUtil.readToString(e.getSvnFile());
