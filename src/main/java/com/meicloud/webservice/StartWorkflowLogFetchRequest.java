...
public class StartWorkflowLogFetchRequest implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(StartWorkflowLogFetchRequest.class, true);


   static {
      typeDesc.setXmlType(new QName("http://www.informatica.com/wsh", "StartWorkflowLogFetchRequest"));
   ...
   public StartWorkflowLogFetchRequest(DIServiceInfo DIServiceInfo, String folderName, String workflowName, Integer workflowRunId, String workflowRunInstanceName) {
   ...
   public synchronized boolean equals(Object obj) {
      if(obj == null) {
         return false;
      } else if(!(obj instanceof StartWorkflowLogFetchRequest)) {
         return false;
      } else {
