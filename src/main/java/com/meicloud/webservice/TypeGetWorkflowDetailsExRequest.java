...
public class TypeGetWorkflowDetailsExRequest implements Serializable {
   ...
   public TypeGetWorkflowDetailsExRequest(DIServiceInfo DIServiceInfo, String folderName, String workflowName, Integer workflowRunId, String workflowRunInstanceName) {
   ...
   public synchronized boolean equals(Object obj) {
      if(obj == null) {
         return false;
      } else if(!(obj instanceof TypeGetWorkflowDetailsExRequest)) {
         return false;
      } else {
