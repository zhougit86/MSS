...
public class EDIServerRunStatus implements Serializable {

   private Token _value_;
   private static HashMap _table_ = new HashMap();
   public static final Token _INITIALIZING = new Token("INITIALIZING");
   public static final Token _RUNNING = new Token("RUNNING");
   public static final Token _SHUTTING_DOWN = new Token("SHUTTING_DOWN");
   ...
   private static TypeDesc typeDesc = new TypeDesc(EDIServerRunStatus.class);


   static {
      typeDesc.setXmlType(new QName("http://www.informatica.com/wsh", "EDIServerRunStatus"));
   }

   protected EDIServerRunStatus(Token value) {
      this._value_ = value;
   ...
   public static EDIServerRunStatus fromValue(Token value) throws IllegalArgumentException {
      EDIServerRunStatus enumeration = (EDIServerRunStatus)_table_.get(value);
      if(enumeration == null) {
   ...
   public static EDIServerRunStatus fromString(String value) throws IllegalArgumentException {
      try {
