...
public class StartSessionLogFetchRequest implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(StartSessionLogFetchRequest.class, true);


   static {
      typeDesc.setXmlType(new QName("http://www.informatica.com/wsh", "StartSessionLogFetchRequest"));
   ...
   public StartSessionLogFetchRequest(DIServiceInfo DIServiceInfo, String folderName, String workflowName, String taskInstancePath) {
   ...
   public synchronized boolean equals(Object obj) {
      if(obj == null) {
         return false;
      } else if(!(obj instanceof StartSessionLogFetchRequest)) {
         return false;
      } else {
