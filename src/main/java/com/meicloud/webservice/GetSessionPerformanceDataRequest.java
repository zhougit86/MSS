...
public class GetSessionPerformanceDataRequest implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(GetSessionPerformanceDataRequest.class, true);


   static {
      typeDesc.setXmlType(new QName("http://www.informatica.com/wsh", "GetSessionPerformanceDataRequest"));
   ...
   public GetSessionPerformanceDataRequest(DIServiceInfo DIServiceInfo, String folderName, String workflowName, String taskInstancePath) {
   ...
   public synchronized boolean equals(Object obj) {
      if(obj == null) {
         return false;
      } else if(!(obj instanceof GetSessionPerformanceDataRequest)) {
         return false;
      } else {
