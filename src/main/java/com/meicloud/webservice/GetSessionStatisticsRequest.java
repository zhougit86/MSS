...
public class GetSessionStatisticsRequest implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(GetSessionStatisticsRequest.class, true);


   static {
      typeDesc.setXmlType(new QName("http://www.informatica.com/wsh", "GetSessionStatisticsRequest"));
   ...
   public GetSessionStatisticsRequest(DIServiceInfo DIServiceInfo, String folderName, String workflowName, String taskInstancePath) {
   ...
   public synchronized boolean equals(Object obj) {
      if(obj == null) {
         return false;
      } else if(!(obj instanceof GetSessionStatisticsRequest)) {
         return false;
      } else {
