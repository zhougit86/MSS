...
public class WorkflowRequest implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("http://www.informatica.com/wsh", "WorkflowRequest"));
   ...
   public WorkflowRequest(DIServiceInfo DIServiceInfo, String folderName, String workflowName, Integer workflowRunId, String workflowRunInstanceName, String reason, Attribute[] attribute, Key[] key, String parameterFileName, Parameter[] parameters, ETaskRunMode requestMode, String taskInstancePath, boolean isAbort, String OSUser) {
